...
namespace eShopping.SharedKernel.Results.Paginations
{
    public class Pagination
    {
        ...
        public Pagination(int itemsCount, FilterBase FilterBase)
            : this(new PaginationSettings(10, 100), itemsCount, FilterBase.PageSize, FilterBase.Page)
        {
        }

        public Pagination(PaginationSettings paginationSettings, int itemsCount, FilterBase FilterBase)
            : this(paginationSettings, itemsCount, FilterBase.PageSize, FilterBase.Page)
        {
        }
